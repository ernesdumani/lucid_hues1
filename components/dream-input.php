<div class="space-y-6">
    ...
    <!-- Results -->
    <div id="dream-results" class="card" style="display: none;">
        <h3 class="text-2xl font-bold text-purple-800 mb-4 text-center">🎨 Your Dream Palette</h3>
        <div class="text-center space-y-2 mb-6">
            <p class="text-sm text-purple-600">
                <strong>Mood:</strong> <span id="dream-mood" class="mood-indicator"></span>
            </p>
        ...
        <div class="text-center mt-4">
            <button onclick="saveDreamPalette()" class="btn btn-secondary">
                💾 Save Palette
            </button>
        </div>
    </div>

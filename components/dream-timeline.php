<div class="space-y-6">
    <div class="card">
        ...
        <div class="flex justify-center gap-4 mb-6">
            <button onclick="loadTimeline()" class="btn btn-primary">
                🔄 Refresh Timeline
            </button>
            <button onclick="clearAllPalettes()" class="btn btn-secondary text-red-600">
                🗑️ Clear All
            </button>
        </div>
    </div>
    ...
    <div id="selected-palette-detail" class="card bg-gradient-to-br from-purple-50 to-indigo-50" style="display: none;">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-center gap-3 mt-4">
                <button onclick="exportSelectedPalette()" class="btn btn-secondary">
                    📤 Export Palette
                </button>
                <button onclick="deleteSelectedPalette()" class="btn btn-secondary text-red-600">
                    🗑️ Delete Palette
                </button>
            </div>
        </div>
